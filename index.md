...
(v0.8.0)](https://ichirio.github.io/rtfreporter/ai/rtfreporter-ai-user-manual-0.8.0.md)**
...
- **Latest release: `v0.8.0`** (2026-09-16) – installable from GitHub
  (`remotes::install_github("ichirio/rtfreporter@v0.8.0")`); not yet on
  CRAN. It rolls up everything since v0.4.0: **listings** end to end
  ...
  a rewritten **border** vocabulary, post-hoc **styling verbs**, column
  pagination
  ([`paginate_cols()`](https://ichirio.github.io/rtfreporter/reference/paginate_cols.md)),
  per-page header values (`set_col_header(values = )`), **figures from
  plot objects**, and the **AI assistant manuals** that now ship inside
  the package. 59 exported functions at v0.4.0; 91 here.
- **Development version on `main`: `0.8.0.9000`.** rtfreporter follows
  ...
  a deliberate, labelled release action, enforced by the
  `version-guard` CI. See
