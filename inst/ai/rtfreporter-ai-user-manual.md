...
**This manual documents rtfreporter 0.8.0.9039** (the development
...
`plan_round` `plan_n` `plan_mutate` `plan_filter` `plan_derive` `plan_fmt` `plan_stub` `plan_group` `plan_hide` `plan_sort` `plan_blanks` `plan_pages`
`plan_style`
