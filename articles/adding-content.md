...
Figures are content too: one figure per page, added with
[`rtf_figures()`](https://ichirio.github.io/rtfreporter/reference/rtf_figures.md).
Pass a list of **plot objects** (a ggplot2 plot, a grid grob, a function
that draws – see the [figures
article](https://ichirio.github.io/rtfreporter/articles/figures.md)),
image paths (PNG/JPEG), or
[`rtfplot()`](https://ichirio.github.io/rtfreporter/reference/rtfplot.md)
...
rtf_figures(list(ggplot(dat, aes(week, mean)) + geom_line()))  # no file needed
```
...
- [Figures](https://ichirio.github.io/rtfreporter/articles/figures.md) —
  plot objects, size on the page, formats
