...
Practical guides for generating RTF deliverables. Start with the
Quickstart, then dive into the Pipe API guide.

- [Clinical RTF Reporting with
  rtfreporter](https://ichirio.github.io/rtfreporter/articles/rtfreporter-quickstart.md):
- [Pipe-Based
  API](https://ichirio.github.io/rtfreporter/articles/rtfreporter-pipes.md):
- [Page and document
...
- [Headers and footers
  (sections)](https://ichirio.github.io/rtfreporter/articles/headers-footers.md):
...
End-to-end recipes for typical clinical TFL deliverables.
...
- [Example: Demographics Table (Table
  14.1.1)](https://ichirio.github.io/rtfreporter/articles/example-demog.md):
- [Example: Lab Toxicity Grade Shift Table (Table
  14.3.x)](https://ichirio.github.io/rtfreporter/articles/example-lab.md):

### For contributors

How rtfreporter is built and how to extend it. Start with the
architecture overview, then the adapter how-to. Each article opens in
English with an “In Japanese” toggle at the top.
