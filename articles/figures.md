...
rtfplot(p)
#> <rtfplot> PNG: file29ba3741cb1c.png
...
fig
#> <rtfplot> PNG: file29ba32bf4dc3.png
#>   Native size:  1950 x 1350 px  (300 x 300 dpi)
#>   Display:      6.50 in (9360 twips) wide x 4.50 in (6480 twips)
#>   Align:        center
```
...
#> <rtfplot> PNG: file29ba6a5c13d4.png
...
#> <rtfplot> PNG: file29ba68a01010.png
#>   Native size:  1950 x 1350 px  (300 x 300 dpi)
...
rtfplot(img)
#> <rtfplot> PNG: file29ba49fe659a.png
