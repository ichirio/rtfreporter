...
rtfplot(p)
#> <rtfplot> PNG: file29054ac509ce.png
...
fig
#> <rtfplot> PNG: file29051cde24f.png
#>   Native size:  1950 x 1350 px  (300 x 300 dpi)
#>   Display:      6.50 in (9360 twips) wide x 4.50 in (6480 twips)
#>   Align:        center
```
...
#> <rtfplot> PNG: file290525195cc.png
...
#> <rtfplot> PNG: file290518235bb5.png
#>   Native size:  1950 x 1350 px  (300 x 300 dpi)
...
rtfplot(img)
#> <rtfplot> PNG: file29051c4d6076.png
