...
rtfplot(p)
#> <rtfplot> PNG: file299e1240f169.png
...
fig
#> <rtfplot> PNG: file299e4f6465df.png
#>   Native size:  1950 x 1350 px  (300 x 300 dpi)
#>   Display:      6.50 in (9360 twips) wide x 4.50 in (6480 twips)
#>   Align:        center
```
...
#> <rtfplot> PNG: file299e124571d5.png
...
#> <rtfplot> PNG: file299e415d3896.png
#>   Native size:  1950 x 1350 px  (300 x 300 dpi)
...
rtfplot(img)
#> <rtfplot> PNG: file299e70d51828.png
